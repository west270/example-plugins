...
class OutputTypesLabelsClient:
    ...
    @command(description='Expected single result of default type STRING with default label')
    ...
    @command(output_types=['JSON'],
             description='Expected single result of type JSON with default label')
    def single_output_types(self):
        return {'output': 'result'}

    @command(output_labels=['Results'],
    ...
    @command(output_types=['JSON', 'JSON'],
    ...
    @command(output_labels=['Result1', 'Result2'],
    ...
    @command(output_type='JSON', output_labels=['Result1', 'Result2'],
    ...
    @command(output_types=['JSON', 'JSON'], output_labels=['Result1'],
