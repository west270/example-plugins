...
class ComplexClient:
    ...
    @parameter(
        key="b",
        type="Boolean",
        description="Just want to test Booleans",
        multi=False,
    ...
    @parameter(
        key="b",
        type="Boolean",
        description="Testing a nullable boolean",
        multi=False,
        display_name="A boolean",
        optional=False,
        default=None,
    ...
    @parameter(
        key="b",
        type="Boolean",
        description="Testing a Boolean with a false default",
        multi=False,
        display_name="A Boolean",
        optional=True,
        default=False,
    ...
    @parameter(
        key="f",
        type="Float",
        description="Just want to test Floats",
        multi=False,
    ...
    @parameter(
        key="i",
        type="Integer",
        description="Just want to test Integers",
        multi=False,
    ...
    @parameter(
        key="list_of_b",
        type="Boolean",
        description="Testing List of Booleans",
        multi=True,
        display_name="A List of Booleans",
        optional=False,
        default=None,
        choices=None,
        model=None,
    ...
    @parameter(
        key="list_of_i",
        type="Integer",
        description="Testing List of Integers",
        multi=True,
        display_name="A List of Integers",
        optional=False,
        default=None,
        choices=None,
        model=None,
    ...
    @parameter(
        key="list_of_s",
        type="String",
        description="Testing List of Strings",
        multi=True,
        display_name="A List of Strings",
        optional=False,
        default=None,
        choices=None,
        model=None,
    ...
    @parameter(
        key="param", optional=True, nullable=True, multi=True, model=MyNestedModel
    )
    ...
    @parameter(
        key="param", optional=True, nullable=True, multi=True, model=MyModelWithDefaults
    )
    ...
    @parameter(
        key="d",
        type="Dictionary",
        description="Testing a Blank Dictionary",
        multi=False,
        display_name="A Dictionary",
        optional=False,
        default=None,
        choices=None,
        model=None,
    ...
    @parameter(
        key="message", optional=False, nullable=False, default=None, type="String"
    )
    ...
    def echo_required_message_nullable_false_with_default(
        self, message="cannot be null"
    ):
        if message is None:
            raise ValueError("Message cannot be None.")
    ...
    def echo_required_message_nullable_true_with_non_null_default(
        self, message="can be null"
    ):
        if message:
            self.logger.info(message)
    ...
    @parameter(
        key="message", optional=False, nullable=True, default=None, type="String"
    )
    ...
    @parameter(
        key="message", type="String", optional=False, nullable=False, regex=r"^Hi.*"
    )
    ...
    @parameter(
        key="s",
        type="String",
        description="Just want to test Small Choices",
        multi=False,
    ...
    @parameter(
        key="echo_max_value",
        type="Integer",
        description="Testing integer maximum constraint",
        multi=False,
        display_name="An Integer",
        optional=False,
        nullable=False,
    ...
    @parameter(
        key="echo_string",
        type="String",
        description="Testing string maximum constraint",
        multi=False,
        display_name="A String",
        optional=False,
        nullable=False,
    ...
    @parameter(
        key="echo_min_value",
        type="Integer",
        description="Testing integer minimum constraint",
        multi=False,
        display_name="An Integer",
        optional=False,
        nullable=False,
    ...
    @parameter(
        key="echo_string",
        type="String",
        description="Testing string minimum constraint",
        multi=False,
        display_name="A String",
        optional=False,
        nullable=False,
    ...
    def prove_env(self):
        ...
        return json.dumps(
            {"DB_NAME": os.getenv("DB_NAME"), "DB_PASS": os.getenv("DB_PASS")}
        )

    @parameter(
        key="system", type="String", optional=False, nullable=False, is_kwarg=True
    )
    @parameter(
        key="command", type="String", optional=False, nullable=False, is_kwarg=True
    )
    @parameter(
        key="comment", type="String", optional=False, nullable=False, is_kwarg=True
    )
    @parameter(
        key="system_version",
        type="String",
    ...
    def large_output(self, mb=16):
        ...
        self.logger.info("Size: %s" % sys.getsizeof(output))
